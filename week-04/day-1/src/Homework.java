...
public class Homework {
  ...
  public static void main(String... args) {
    ...
    fa0.put("type", "Olaf");
    fa0.put("age", 12);
    fa0.put("leaf color", Color.AQUAMARINE);
    fa0.put("sex", "male");
    map.add(fa0);
    ...
    fa1.put("type", "Olaf");
    fa1.put("age", 12);
    fa1.put("leaf color", Color.TURQUOISE);
    fa1.put("sex", "male");
    map.add(fa1);
    ...
    fa4.put("type", "Olaf");
    fa4.put("age", 12);
    fa4.put("leaf color", Color.YELLOWGREEN);
    fa4.put("sex", "male");
    map.add(fa4);
  }
}
